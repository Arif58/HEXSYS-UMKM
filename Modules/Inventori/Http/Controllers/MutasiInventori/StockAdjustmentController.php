...
class StockAdjustmentController extends Controller{
    private $folder_path = 'mutasi-inventori.stock-adjustment';
    ...
    function index(){
        $pageFileName  = 'index';
        $title         = 'Transaksi Penyesuaian Stok';
    ...
    function update(Request $request, $id){
        ...
        DB::transaction(function () use($request, $id) {
            ...
            $newStock->quantity   = $request->jumlah_trx;
            ...
            $newMove->new_stock       = $request->jumlah_trx;
