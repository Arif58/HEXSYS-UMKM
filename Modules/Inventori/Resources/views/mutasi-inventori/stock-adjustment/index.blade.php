                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-float">
                                    ...
                                    <input type="number" name="jumlah_trx" id="jumlah_trx" min="0" class="form-control text-uppercase" required="" placeholder="" aria-invalid="false">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<script>
    var tabelData;
    var baseUrl     = "{{ url('inventori/mutasi-inventori/penyesuaian/') }}";
