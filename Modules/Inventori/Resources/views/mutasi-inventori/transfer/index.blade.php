                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-float">
                                    ...
                                    <select name="pos_cd_destination" class="form-control form-control-select2 select-search" required data-fouc>
                                        <option value="">=== Pilih Gudang ===</option>
                                        @foreach ($gudangs as $item)
                                        <option value="{{ $item->pos_cd }}">{{ $item->pos_nm }}</option>                                                        
                                        @endforeach
...
<script>
    var tabelData;
    var baseUrl     = "{{ url('inventori/mutasi-inventori/transfer/') }}";
    ...
    $(document).ready(function(){
        ...
        $('#submit-button').click(function(){
            ...
            if(keluar > stok){
                swal({
                    title: "Permintaan Transfer Melebihi Stok!",
                    type: "warning",
