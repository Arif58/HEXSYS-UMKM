                    ...
                    <form class="form-validate-jquery" id="form-item">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group form-group-float">
                                    <input name="item_nm" id="item_nm" class="form-control" required data-fouc/>
                                </div>
                            </div>
                            <div class="col-md-4">
    ...
    $(document).ready(function(){
        ...
        @if($po)
            ...
            tabelData = $('#tabel-data').DataTable({
                ...
                order		: [[2,'ASC']], 
                ajax		: {
                    url : "{{ url('inventori/pembelian/purchase-order/') }}"+'/'+'data',
                    type: "POST",
                    data: function(data){
				...
				$('#form-item').submit(function(e){
                    ...
                    // handle the invalid form...
                        ...
                        if(saveMethod == 'tambah'){
							var url     = "{{ url('inventori/pembelian/purchase-order/') }}"+'/item/'+dataCd;
							var method  = 'POST';
						}else{
							var url     = "{{ url('inventori/pembelian/purchase-order/') }}"+'/item/'+dataItem;
							var method  = 'PUT';
						}
                                ...
                                success: function(response)
                                {
                                    if (response.status == 'ok') {
                                        swal({
											...
											window.location = "{{ url('inventori/pembelian/purchase-order/') }}" + "/" + dataCd;
                                        });
                                    }else{
