...
<body>
	...
	<div class="wrapper">
		...
		@php
		$poTitle = 'BERITA ACARA SERAH TERIMA BARANG';
		...
		@if(!empty($data[0]))
		@if(!in_array($data[0]->dana_tp_nm,array('DANA_TP_01')) )	
		<div class="content">
			<div>
		        <table border="0" style="border: transparent;" style="">
		            <tbody>
		                ...
		                <tr>
		                    <td class="data" width="10%">I. Nama</td>
		                    <td class="data" width="3%">:</td>
		                    <td class="data"></td>
		                </tr>
						<tr>
		                    <td class="data" width="10%">&nbsp;&nbsp;&nbsp;Jabatan</td>
		                    <td class="data" width="3%">:</td>
		                    <td class="data"></td>
		                </tr>
						<tr>
		                    <td class="data" colspan="3">&nbsp;&nbsp;
							selanjutnya disebut sebagai PIHAK KESATU</td>
		                </tr>
						<tr>
		                    <td class="data" colspan="3">&nbsp;</td>
		                </tr>
		                <tr>
		                    <td class="data" width="10%">II. Nama</td>
		                    <td class="data" width="3%">:</td>
		                    <td class="data"></td>
		                </tr>
						<tr>
						...
						<tr>
		                    <td class="data" colspan="3">
							<p>
							Pihak KESATU telah menyerahkan barang kepada pihak KEDUA dan PIHAK KEDUA menerima barang tersebut dalam keadaan -----baik dan cukup----sesuai barang yang dipesan, berupa : 
							</p>
							</td>
		                </tr>
						<tr>
		...
		<div class="content">
		    <div class="ctn-lft">
		        <table border="0" style="border: transparent;" style="">
		            <tbody>
		                <tr>
		                    <td class="data" style="">Nomor SPB</td>
		                    <td class="data" style="width: 1px">:</td>
		                    <td class="data">
							<!--<?= $data[0]->po_no ?>-->
							<?= str_pad($data[0]->data_no,3,"0",STR_PAD_LEFT) .'/' .$no_bulan .'/' .date("Y",strtotime($data[0]->trx_date)) ?>
							</td>
							<td class="data" style="" width="10%"></td>
							<td class="data" style="" width="25%">Sumber Dana</td>
		                    <td class="data" style="width: 1px">:</td>
							<td class="data"><?= $data[0]->dana_tp_nm ?></td>
		                </tr>
		                <tr>
							...
							<td class="data" style="" width="10%"></td>
							<td class="data" style="" width="25%">Unit</td>
		                    <td class="data" style="width: 1px">:</td>
							<td class="data"><?= $data[0]->po_unit ?></td>
		                </tr>
						<tr>
		                    <td class="data">Supplier</td>
		                    <td class="data">:</td>
		                    <td class="data" colspan="4"><?= $data[0]->supplier_nm ?></td>
		                </tr>
						<!--
		                <tr>
		                    <td class="data">Alamat</td>
		                    <td class="data">:</td>
		                    <td class="data" colspan="4"><?= $data[0]->supp_add ?></td>
		                </tr>
						-->
		            </tbody>
		        </table>
			...
			<table class="table" border="1">
			  ...
			  <?php } ?>
				...
				<div class="colsright text-align-left form-group-bottom-15 " style="margin-top: 10px;margin-left: 40px">
		             ...
		             <tr>
		                 <th class="notbold" style="width: 25%">&nbsp;&nbsp;&nbsp;&nbsp;Dibuat&nbsp;&nbsp;&nbsp;&nbsp;</th>
						 <th class="notbold" style="width: 25%">&nbsp;&nbsp;&nbsp;&nbsp;Diperiksa&nbsp;&nbsp;&nbsp;&nbsp;</th>
		                 <th class="notbold" style="width: 25%">&nbsp;&nbsp;&nbsp;&nbsp;Menerima&nbsp;&nbsp;&nbsp;&nbsp;</th>
		             </tr>
		             <tr class="table.table-noborder">
						<td><p style="text-align: left;">Tgl:</p></td>
		                <td><p style="text-align: left;">Tgl:</p></td>
		                <td><p style="text-align: left;">Tgl:</p></td>
		             </tr>
					 <tr>
						<td style="height: 100px"><p style="margin-top: 50px;text-align: center;"></p>
						</td>
		                <td style="height: 100px"><p style="margin-top: 50px;text-align: center;"></p>
						</td>
		                <td style="height: 100px"><p style="margin-top: 50px;text-align: center;"></p>
					...
					<table style="margin-top: 20px">
		             <tr>
						 ...
						 <th class="notbold" style="width: 25%">Yang Menyerahkan</th>
		                 <th class="notbold" style="width: 25%">Yang Memerintahkan</th>
		             </tr>
		             <tr>
