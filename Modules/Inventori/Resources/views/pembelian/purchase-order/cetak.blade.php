...
<body>
	...
	<div class="wrapper">
		...
		if ($data[0]->popr_st == '1') {
			...
			$poTitle = 'SURAT PEMESANAN BARANG';
		}
		@endphp
		<header class="header">
		    <div class="info">
		...
		@if(!empty($data[0]))
		@if ( ($data[0]->dana_tp_nm == 'DANA_TP_01') and $data[0]->po_st != 'INV_TRX_ST_5')
		<table border="0" style="border: transparent;" style="">
		<tr>
			<td align="left" width="50%">
				<p>Supplier</p>
				<p><?= $data[0]->supplier_nm ?></p>
				<p><?= $data[0]->supp_add ?></p>
			</td>
			<td align="left" width="50%">
				<p>Delivered To</p>
		    ...
		    <div class="ctn-lft">
		        <table border="0" style="border: transparent;" style="">
		            <tbody>
						...
						-->
						@if ($data[0]->po_st != 'INV_TRX_ST_5')
							@if ($data[0]->dana_tp_nm == 'DANA_TP_01')
							<tr>
							...
							<tr>
								<td class="data" style="" colspan="3">&nbsp;</td>
							</tr>
							<tr>
							...
							@elseif ($data[0]->dana_tp_nm == 'DANA_TP_01')
							<tr>
								<td class="data" style="" colspan="3">&nbsp;</td>
							</tr>
							<tr>
