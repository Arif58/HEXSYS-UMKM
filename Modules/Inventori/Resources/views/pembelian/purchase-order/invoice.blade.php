                ...
                <table class="table datatable-pagination" id="tabel-data" width="100%">
                    <thead>
						<tr>
                            ...
                            <th id="invoice_st_nm_table">Status</th>
...
<script>
    var tabelData;
	var baseUrl     = "{{ url('inventori/pembelian/invoice/') }}";
    ...
    $(document).ready(function(){
        ...
        tabelData = $('#tabel-data').DataTable({
            ...
            columns: [
                ...
                { data: 'invoice_st_nm', name:'invoice_st_nm', visible:true},
		...
		$(document).on('click', '.invoice-close',function(){ 
            var rowData = tabelData.row($(this).parents('tr')).data();
            dataCd      = rowData.po_cd;
