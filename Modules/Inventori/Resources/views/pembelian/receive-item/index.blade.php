	...
	<div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group form-group-float">
                        <input name="ri_no_param" id="ri_no_param" placeholder="Pencarian Nomor Receive" class="form-control" data-fouc />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group form-group-float">
            ...
            <button type="button" class="btn btn-primary legitRipple" id="tambah"><i class="icon-add mr-2"></i>Receive</button>
            <!--<button type="button" class="btn btn-info legitRipple" id="detail"><i class="icon-menu-open mr-2"></i>Detail Penerimaan Barang</button>-->
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('keyup', '#ri_no_param',function(){ 
            tabelData.column('#ri_no_table').search($(this).val()).draw();
        });
        ...
        $('#reload-table').click(function(){
			$('input[name=ri_no_param]').val('').trigger('keyup');
			tabelData.ajax.reload();
		});
                        ...
                        $.ajax({
                            ...
                            success: function(response)
                            {
                                if (response.status == 'ok') {
									...
									window.location = "{{ url('inventori/pembelian/receive-item/') }}";
                                }else{
