...
<script>
    var tabelData;
    var baseUrl     = "{{ url('inventori/report/purchase-order/') }}";
    ...
    $(document).ready(function(){
        ...
        tabelData = $('#tabel-data').DataTable({
			...
			buttons: [
				...
				},
				{
					...
					customize: function (doc) {
						...
						var reportTitle =  'Laporan Permohonan Pembelian ' + tanggalSelect + ' | ' + unitSelect;	
												
						//--Full width table
						//doc.content[1].table.widths =Array(doc.content[1].table.body[0].length + 1).join('*').split('');
						doc.content[1].table.widths = [60,60,100,100,80,100];
            ...
            columns: [
                ...
                { data: 'supplier_nm', name:'supplier_nm', visible:false},
