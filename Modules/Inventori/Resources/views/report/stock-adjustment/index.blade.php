...
<script>
    var tabelData;
	var baseUrl     = "{{ url('inventori/report/penyesuain-stok/') }}";
    ...
    $(document).ready(function(){
        ...
        tabelData = $('#tabel-data').DataTable({
			...
			buttons: [
				...
				},
				{
					...
					customize: function (doc) {
						...
						var reportTitle =  'Laporan Penyesuaian Stok ' + gudangSelect + ' | ' + tanggalSelect;	
												
						//--Full width table
						//doc.content[1].table.widths =Array(doc.content[1].table.body[0].length + 1).join('*').split('');
						doc.content[1].table.widths = [220,120,50,50,50];
            ...
            columns: [
				...
				{ data: "jumlah_trx", name : "jumlah_trx", visible:true, render: $.fn.dataTable.render.number( '.', ',', 2, '' ) },
