                    ...
                    <div class="card-group-control card-group-control-right">
                        <div class="card">
                            <div class="card-header bg-slate">
                                <h6 class="card-title">
                                    <a data-toggle="collapse" class="text-white" href="#collapsible-control-right-group1">Data Siswa</a>
                                </h6>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header bg-slate">
                                <h6 class="card-title">
                                    <a class="collapsed text-white" data-toggle="collapse" href="#collapsible-control-right-group3">Data Umum</a>
                                </h6>
                            </div>
