...
class CreateErpFnCmGetGroupApprovalStFunction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP FUNCTION if exists erp.fn_cm_get_group_approval_st(p_pstrcompcd character varying, p_pstrrolecd character varying, p_pstrtrxcd character varying);");
        DB::unprepared("
            CREATE OR REPLACE FUNCTION erp.fn_cm_get_group_approval_st(p_pstrcompcd character varying, p_pstrrolecd character varying, p_pstrtrxcd character varying)
                RETURNS integer
                LANGUAGE plpgsql
            AS $$
    ...
    {
        Schema::dropIfExists('erp_fn_cm_get_group_approval_st_function');
    }
}
