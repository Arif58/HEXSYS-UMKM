...
class CreateErpSpApProcessApprovalProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP FUNCTION if exists erp.sp_ap_process_approval(p_pstrCompCd Varchar(10),p_pstrRoleCd Varchar(20),p_pstrTrxCd Varchar(20),p_pstrUserId Varchar(20),p_pstrUserNm Varchar(100)); ");
        DB::unprepared("
        CREATE OR REPLACE FUNCTION erp.sp_ap_process_approval(p_pstrCompCd Varchar(10),p_pstrRoleCd Varchar(20),p_pstrTrxCd Varchar(20),p_pstrUserId Varchar(20),p_pstrUserNm Varchar(100)) 
            RETURNS varchar
        AS $$
        ...
        BEGIN
            ...
            SELECT ap_approval_cd
            INTO v_strApproval
            FROM erp.ap_reference
            WHERE comp_cd=p_pstrCompCd
            AND ref_year=(SELECT MAX(ref_year) FROM erp.ap_reference
            ...
            UPDATE erp.ap_trx
            SET ap_st=v_strApprovalStatus,
            approve_by=p_pstrUserNm,
            approve_date=NOW(),
            approve_no=v_intApprovalNo
            WHERE ap_cd=p_pstrTrxCd;
