...
class CreateErpSpCmProcessApprovalProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP FUNCTION if exists erp.sp_cm_process_approval(p_pstrCompCd Varchar(10),p_pstrRoleCd Varchar(20),p_pstrTrxCd Varchar(20),p_pstrUserId Varchar(20),p_pstrUserNm Varchar(100)); ");
        DB::unprepared("
        CREATE OR REPLACE FUNCTION erp.sp_cm_process_approval(p_pstrCompCd Varchar(10),p_pstrRoleCd Varchar(20),p_pstrTrxCd Varchar(20),p_pstrUserId Varchar(20),p_pstrUserNm Varchar(100)) 
            RETURNS varchar
        AS $$
        ...
        BEGIN
            ...
            v_strTrxApprovalCode := 'CM' || p_pstrTrxCd;
            
            SELECT cm_approval_cd
            INTO v_strApproval
            FROM erp.cm_reference
            WHERE comp_cd=p_pstrCompCd
            AND ref_year=(SELECT MAX(ref_year) FROM erp.cm_reference
            ...
            UPDATE erp.cm_trx
            SET cm_st=v_strApprovalStatus,
            approve_by=p_pstrUserNm,
            approve_date=NOW(),
            approve_no=v_intApprovalNo
            WHERE cm_cd=p_pstrTrxCd;
