...
class CreateErpSpGlRptGetLedgerProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("DROP function if exists erp.sp_gl_rpt_get_ledger (p_pstrCompCd Varchar(10), p_pintYear int, p_pintMonth int, p_pstrCoaCdStart Varchar(20), p_pstrCoaCdEnd Varchar(20), p_pstrDanaTp Varchar(20));");
        DB::unprepared("
			CREATE OR REPLACE FUNCTION erp.sp_gl_rpt_get_ledger (p_pstrCompCd Varchar(10), p_pintYear int, p_pintMonth int, p_pstrCoaCdStart Varchar(20), p_pstrCoaCdEnd Varchar(20), p_pstrDanaTp Varchar(20))
				RETURNS table(
					r_coa_cd varchar(20),
					r_trx_date date, 
					r_cc_cd varchar(20),
        ...
        //DB::unprepared("SELECT * from erp.sp_gl_rpt_get_ledger('HEXSYS', date_part('year', now())::int, date_part('month', now())::int, ''::varchar, ''::varchar, ''::varchar);");
    }
