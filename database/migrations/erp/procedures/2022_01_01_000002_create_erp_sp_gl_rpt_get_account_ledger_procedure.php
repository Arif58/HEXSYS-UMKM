...
class CreateErpSpGlRptGetAccountLedgerProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("DROP function if exists erp.sp_gl_rpt_get_account_ledger (p_pstrCompCd Varchar(10), p_pintYear int, p_pintMonth int, p_pstrCoa Varchar(20), p_pstrDanaTp Varchar(20));");
        DB::unprepared("
			CREATE OR REPLACE FUNCTION erp.sp_gl_rpt_get_account_ledger (p_pstrCompCd Varchar(10), p_pintYear int, p_pintMonth int, p_pstrCoa Varchar(20), p_pstrDanaTp Varchar(20))
				RETURNS table(
					r_coa_cd varchar(20),
					r_trx_date date, 
					r_cc_cd varchar(20),
