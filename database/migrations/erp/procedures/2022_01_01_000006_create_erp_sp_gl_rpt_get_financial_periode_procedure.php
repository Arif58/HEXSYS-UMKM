...
class CreateErpSpGlRptGetFinancialPeriodeProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("DROP function if exists erp.sp_gl_rpt_get_financial_periode (p_pstrCompCd Varchar(10), p_pintYear int, p_pintMonth int, p_pstrDanaTp Varchar(20));");
        DB::unprepared("
			CREATE OR REPLACE FUNCTION erp.sp_gl_rpt_get_financial_periode (p_pstrCompCd Varchar(10), p_pintYear int, p_pintMonth int, p_pstrDanaTp Varchar(20))
			RETURNS table(
				com_cd varchar(20),
				code_nm varchar(100),
