...
class CreateErpSpGlRptGetAccountLedgerDateProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("DROP function if exists erp.sp_gl_rpt_get_account_ledger_date (p_pstrCompCd Varchar(10), p_dateStart date, p_dateEnd date, p_pstrCoa Varchar(20), p_pstrDanaTp Varchar(20));");
        DB::unprepared("
			CREATE OR REPLACE FUNCTION erp.sp_gl_rpt_get_account_ledger_date (p_pstrCompCd Varchar(10), p_dateStart date, p_dateEnd date, p_pstrCoa Varchar(20), p_pstrDanaTp Varchar(20))
				RETURNS table(
					r_coa_cd varchar(20),
					r_trx_date date, 
					r_cc_cd varchar(20),
			...
			BEGIN
				...
				AND B.coa_cd=p_pstrCoa
				--AND B.dana_tp=p_pstrDanaTp
