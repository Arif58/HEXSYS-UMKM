...
class CreateErpSpGlRptGetLedgerCompProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::unprepared("DROP function if exists erp.sp_gl_rpt_get_ledger_comp (p_pstrCompCd Varchar(10), p_pintYear int, p_pintMonth int, p_pstrCoaCdStart Varchar(20), p_pstrCoaCdEnd Varchar(20), p_pstrDanaTp Varchar(20));");
        DB::unprepared("
			CREATE OR REPLACE FUNCTION erp.sp_gl_rpt_get_ledger_comp (p_pstrCompCd Varchar(10), p_pintYear int, p_pintMonth int, p_pstrCoaCdStart Varchar(20), p_pstrCoaCdEnd Varchar(20), p_pstrDanaTp Varchar(20))
				RETURNS table(
			...
			BEGIN
				...
				THEN
					...
					A.note AS journal_note, B.dc_value, B.trx_amount,
