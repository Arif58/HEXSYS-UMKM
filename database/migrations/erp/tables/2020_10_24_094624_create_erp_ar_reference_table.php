...
class CreateErpArReferenceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('erp.ar_reference', function (Blueprint $table) {
            $table->uuid('ar_reference_id')->primary();
            ...
            $table->string('ar_approval_cd',20)->nullable();
    ...
    {
        Schema::dropIfExists('erp.ar_reference');
    }
}
