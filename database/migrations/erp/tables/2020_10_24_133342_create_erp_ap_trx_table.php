...
class CreateErpApTrxTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('erp.ap_trx', function (Blueprint $table) {
            $table->string('ap_cd',20)->primary();
            $table->string('comp_cd',20)->nullable();
            $table->string('ap_no',20)->nullable();
            $table->string('ap_source',5)->nullable();
            $table->string('ap_source_cd',20)->nullable();
    ...
    {
        Schema::dropIfExists('erp.ap_trx');
    }
}
