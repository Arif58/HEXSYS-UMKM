...
class CreateErpApTrxPaymentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('erp.ap_trx_payment', function (Blueprint $table) {
            $table->uuid('ap_trx_payment_id')->primary();
            $table->string('ap_cd',20);
    ...
    {
        Schema::dropIfExists('erp.ap_trx_payment');
    }
}
