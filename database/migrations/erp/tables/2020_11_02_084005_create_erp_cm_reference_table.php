...
class CreateErpCmReferenceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('erp.cm_reference', function (Blueprint $table) {
            $table->uuid('cm_reference_id')->primary();
            ...
            $table->string('cm_approval_cd',20)->nullable();
    ...
    {
        Schema::dropIfExists('erp.cm_reference');
    }
}
