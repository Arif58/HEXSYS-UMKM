...
class CreateInvSpPoProcessApprovalProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP FUNCTION if exists inv.sp_po_process_approval(p_pstrCompCd Varchar(10),p_pstrRoleCd Varchar(20),p_pstrTrxCd Varchar(20),p_pstrUserId Varchar(20),p_pstrUserNm Varchar(100)); ");
        DB::unprepared("
        CREATE OR REPLACE FUNCTION inv.sp_po_process_approval(p_pstrCompCd Varchar(10),p_pstrRoleCd Varchar(20),p_pstrTrxCd Varchar(20),p_pstrUserId Varchar(20),p_pstrUserNm Varchar(100)) 
            RETURNS varchar
        AS $$
        ...
        BEGIN
            ...
            v_strTrxApprovalCode := 'PO' || p_pstrTrxCd;
            ...
            WHEN 'APPROVAL_TP_01' THEN
                v_intApprovalNo := 0;
                v_strApprovalStatus := 'INV_TRX_ST_3';
            WHEN 'APPROVAL_TP_02' THEN
                ...
                THEN
                    v_strApprovalStatus := 'INV_TRX_ST_2';
                ELSE
                    v_strApprovalStatus := 'INV_TRX_ST_3';
                END IF;
            ...
            UPDATE inv.po_purchase_order
            SET po_st=v_strApprovalStatus,
            approve_by=p_pstrUserNm,
            approve_date=NOW(),
            approve_no=v_intApprovalNo
            WHERE po_cd=p_pstrTrxCd::uuid;
