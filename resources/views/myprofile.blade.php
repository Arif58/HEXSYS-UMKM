...
<script>
                    ...
                    $.ajax({
                        ...
                        success   : function(response){
                            if(response.status == 'ok') {     
                                ...
                                swal({title: "Proses gagal",text: response.message, type: "error",showCancelButton: false,showConfirmButton: false,timer: 1000});
                            }
                        },
    ...
    $(document).ready(function(){
        ...
        $('#form-password').submit(function(e){
            ...
            //--Handle the invalid form
                ...
                var url     = '{{ url("/my-profile/password/") }}';
                var method  = 'POST';
    ...
    function init(){
        var urlUpdate='{{ url("/my-profile/".$dataUser->user_id) }}';
